    ...
    <Card className="bg-white border-indigo-200 shadow-sm">
      ...
      <CardContent>
        ...
        <div className="flex items-center gap-2">
          <div className="flex-1 bg-gray-100 rounded-lg px-4 py-3 font-mono text-lg font-semibold tracking-wider text-center border border-gray-200">
            {loading ? (
          ...
          <Button
            ...
            variant="outline"
            size="icon"
            className="h-12 w-12 shrink-0 border-indigo-300 hover:bg-indigo-50 hover:border-indigo-400 text-gray-700"
